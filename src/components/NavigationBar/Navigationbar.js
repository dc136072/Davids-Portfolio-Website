...
import DarkModeToggle from '../../utils/DarkModeToggle/DarkModeToggle'; // Import the DarkModeToggle component
    ...
    return (
        <nav className="navbar" role="navigation">
            ...
            <div className="top-right-items">
                ...
                <a href="https://docs.google.com/document/d/1DMEKYg2xYZV-iGQCbaUXoPnTu2loMWfl/edit?usp=sharing&ouid=108893038236690768077&rtpof=true&sd=true" target="_blank" className="github-logo-link" rel="noopener noreferrer" aria-label="Resume on Google Docs">
                    <div className="navbar-icon csv-icon"></div>
                </a>
                <a href="https://www.linkedin.com/in/david-cha-605635250/" target="_blank" className="linkedin-icon-link" rel="noopener noreferrer" aria-label="LinkedIn Profile">
                    <div className="navbar-icon linkedin-icon"></div>
                </a>
                <a href="https://github.com/dc136072" target="_blank" className="github-icon-link" rel="noopener noreferrer" aria-label="GitHub Profile">
