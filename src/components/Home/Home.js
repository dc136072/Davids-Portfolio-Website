...
import { useDarkMode } from '../../utils/DarkModeToggle/DarkModeContext'; // Import custom hook for dark mode state
            ...
            <div className="home__left">
                <div className={textContainerClass}>
                    <div className="block-wrapper">
                        ...
                        <h1 className="home__text-name">David Cha</h1>
