...
import './Skills.css';
import HoverImage from '../../utils/HoverImage.js';
...
function Skills() {
    ...
    return (
        <section className="skills" id="skills" ref = {skillsRef}>
            ...
            <h2 className={skillsSubheaderClass}>Building vibrant websites, one line of code at a time.</h2>
             {/* Skill Categories */}
            <div className="skills-category-container">
                ...
                <div className = "skills-icon-header-wrapper">
                    ...
                    <p>
                        Learning new way to code are exciting challenges for me to learn new technologies and build something beautiful.
                        I always on Youtube finding things to learn & I'm looking forward to expanding my knowledge.
                    </p>
                </div>      
                {/* Category - Caring */}
                <div className={skillsCategoryClassLeft} ref={skillsRef}>
